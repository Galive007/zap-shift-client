    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center my-10'>
                <button className='px-3 md:px-8 bg-secondary text-primary rounded-3xl font-bold py-1 md:py-2' onClick={handleClick}>See More FAQ’s</button>
                <div>
                    <RiArrowRightUpLine className='text-primary text-3xl bg-secondary rounded-3xl' />
                </div>
            </div>
        </div>
    );
